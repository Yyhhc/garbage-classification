...
def train(epochs):
    ...
    train_ds, val_ds, class_names = data_load("D:/研究生/学期历程/2021第一学年第二学期/软件项目管理/项目/trash_classification_tf2.3-master/trash_jpg", 224, 224,
...
if __name__ == '__main__':
    train(epochs=30)  # todo epoch可以设置为你想要的轮数
